...
/**
 * Classe qui permet de gérer les requêtes de la vue FleurView.
 */
public class FleurViewQueries {
   ...
   * @param fournisseurId L'id du fournisseur de la fleur
   */
  public void ajoutFleur(String nom, float age, float dureeVie, float prix, int quantite, int fournisseurId) {
    try {
      String requete = "INSERT INTO FLEUR (nom, age, duree_vie, prix_unitaire, quantite, fournisseur_id) VALUES ('" + nom + "', " + age + ", " + dureeVie + ", " + prix + ", " + quantite + ", " + fournisseurId + ")";
