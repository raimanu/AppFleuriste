...
/**
 * Classe FournisseurFleurView qui permet de créer une fenêtre pour afficher les fleurs d'un fournisseur.
 */
public class FournisseurFleurView extends JPanel {
   ...
   */
  public FournisseurFleurView(String password, String commandeId) {
    ...
    conn.getFournisseurFleur(commandeId, model);
    this.add(scrollPane);
