...
/**
 * Classe qui permet de créer la vue de la table ClientCommande.
 */
public class ClientCommandeView extends JPanel {
   ...
   */
  public ClientCommandeView(String password, String clientId) {
    ...
    conn.TableClientCommande(clientId, model);
    this.add(scrollPane);
